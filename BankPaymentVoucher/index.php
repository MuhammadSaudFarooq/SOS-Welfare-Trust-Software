...
<body>
	<div class="container">
		...
		<form action="action.php" method="post">
			...
			<div class="form-group">
				<div class="row">
					<label class="col-md-2">Paid To</label>
					<div class="col-md-10">
			...
			<div class="form-group">
				...
				<div class="row">
					<input type="text" class="form-control col-md-2" name="account_code_11">
					<input type="text" class="form-control col-md-3" name="head_of_account_11">
					<input type="text" class="form-control col-md-1" name="folio_11">
					<input type="text" class="form-control col-md-2" name="debit_rs_11">
					<input type="text" class="form-control col-md-1" name="debit_ps_11">
					<input type="text" class="form-control col-md-2" name="credit_rs_11">
					<input type="text" class="form-control col-md-1" name="credit_ps_11">
				</div>
				<div class="row">
					<input type="text" class="form-control col-md-2" name="account_code_12">
					<input type="text" class="form-control col-md-3" name="head_of_account_12">
					<input type="text" class="form-control col-md-1" name="folio_12">
					<input type="text" class="form-control col-md-2" name="debit_rs_12">
					<input type="text" class="form-control col-md-1" name="debit_ps_12">
					<input type="text" class="form-control col-md-2" name="credit_rs_12">
					<input type="text" class="form-control col-md-1" name="credit_ps_12">
				</div>
			</div>
			<div class="form-group">
				<div class="row">
